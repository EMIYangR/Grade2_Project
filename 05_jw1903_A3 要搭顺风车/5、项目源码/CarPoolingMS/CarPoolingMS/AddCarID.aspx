<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="AddCarID.aspx.cs" Inherits="CarPoolingMS.AddCarID" %>
     ...
     <div id="fabumsg">
        ...
        <table>
            ...
            <tr>
                <td colspan="2">
                    <p class="btn">
                        <asp:Button ID="Button1" class="form-control btn btn-primary" runat="server" Text="完成" Width="150px" OnClick="Button1_Click" />
                    </p>
                </td>
            </tr>
        </table>
