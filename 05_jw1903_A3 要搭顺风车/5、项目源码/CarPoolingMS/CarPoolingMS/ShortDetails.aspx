<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="ShortDetails.aspx.cs" Inherits="CarPoolingMS.ShortDetails" %>
    ...
    <div id="mg">
        ...
        <div id="ld">
            ...
            <div id="msg">
                ...
                <p>
                    类型：
                    <asp:Label ID="Label2" runat="server" Text="短途"></asp:Label>
                </p>
                <p>
                    线路：
        ...
        <div>
            ...
            <p>
                ...
                <asp:Button ID="Button1" runat="server" Text="加入" OnClick="Button1_Click" class="btn btn-soft-success" />
